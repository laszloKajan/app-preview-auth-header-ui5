		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Preview with Auth Header",
									"targetURL": "#apppreviewauthheaderui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apppreviewauthheaderui5-display": {
								"semanticObject": "apppreviewauthheaderui5",
								"action": "display",
								"description": "App Preview with Auth Header.",
								"title": "App Preview with Auth Header",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.preview.auth.header.ui5",
									"url": sap.ui.require.toUrl("app/preview/auth/header/ui5")
								}
							}
						}
					}
